...
def test_find_moon_phases():
    expected_phases = [
        (datetime(2025, 1, 6, 23, 56, 18, tzinfo=pytz.utc), 'First Quarter'),
        (datetime(2025, 1, 13, 22, 26, 55, tzinfo=pytz.utc), 'Full Moon'),
        (datetime(2025, 1, 21, 20, 30, 47, tzinfo=pytz.utc), 'Last Quarter'),
        (datetime(2025, 1, 29, 12, 35, 59, tzinfo=pytz.utc), 'New Moon'),
        (datetime(2025, 2, 5, 8, 2, 9, tzinfo=pytz.utc), 'First Quarter'),
        (datetime(2025, 2, 12, 13, 53, 24, tzinfo=pytz.utc), 'Full Moon'),
        (datetime(2025, 2, 20, 17, 32, 33, tzinfo=pytz.utc), 'Last Quarter'),
        (datetime(2025, 2, 28, 0, 44, 50, tzinfo=pytz.utc), 'New Moon'),
        (datetime(2025, 3, 6, 16, 31, 38, tzinfo=pytz.utc), 'First Quarter'),
        (datetime(2025, 3, 14, 6, 54, 39, tzinfo=pytz.utc), 'Full Moon'),
        (datetime(2025, 3, 22, 11, 29, 26, tzinfo=pytz.utc), 'Last Quarter'),
        (datetime(2025, 3, 29, 10, 57, 50, tzinfo=pytz.utc), 'New Moon'),
        (datetime(2025, 4, 5, 2, 14, 41, tzinfo=pytz.utc), 'First Quarter'),
        (datetime(2025, 4, 13, 0, 22, 16, tzinfo=pytz.utc), 'Full Moon'),
        (datetime(2025, 4, 21, 1, 35, 34, tzinfo=pytz.utc), 'Last Quarter'),
        (datetime(2025, 4, 27, 19, 31, 9, tzinfo=pytz.utc), 'New Moon'),
        (datetime(2025, 5, 4, 13, 51, 46, tzinfo=pytz.utc), 'First Quarter'),
        (datetime(2025, 5, 12, 16, 55, 56, tzinfo=pytz.utc), 'Full Moon'),
        (datetime(2025, 5, 20, 11, 58, 46, tzinfo=pytz.utc), 'Last Quarter'),
        (datetime(2025, 5, 27, 3, 2, 21, tzinfo=pytz.utc), 'New Moon'),
        (datetime(2025, 6, 3, 3, 40, 58, tzinfo=pytz.utc), 'First Quarter'),
        (datetime(2025, 6, 11, 7, 43, 50, tzinfo=pytz.utc), 'Full Moon'),
        (datetime(2025, 6, 18, 19, 19, 7, tzinfo=pytz.utc), 'Last Quarter'),
        (datetime(2025, 6, 25, 10, 31, 37, tzinfo=pytz.utc), 'New Moon'),
        (datetime(2025, 7, 2, 19, 30, 11, tzinfo=pytz.utc), 'First Quarter'),
        (datetime(2025, 7, 10, 20, 36, 48, tzinfo=pytz.utc), 'Full Moon'),
        (datetime(2025, 7, 18, 0, 37, 40, tzinfo=pytz.utc), 'Last Quarter'),
        (datetime(2025, 7, 24, 19, 11, 12, tzinfo=pytz.utc), 'New Moon'),
        (datetime(2025, 8, 1, 12, 41, 19, tzinfo=pytz.utc), 'First Quarter'),
        (datetime(2025, 8, 9, 7, 55, 4, tzinfo=pytz.utc), 'Full Moon'),
        (datetime(2025, 8, 16, 5, 12, 14, tzinfo=pytz.utc), 'Last Quarter'),
        (datetime(2025, 8, 23, 6, 6, 33, tzinfo=pytz.utc), 'New Moon'),
        (datetime(2025, 8, 31, 6, 25, 12, tzinfo=pytz.utc), 'First Quarter'),
        (datetime(2025, 9, 7, 18, 8, 54, tzinfo=pytz.utc), 'Full Moon'),
        (datetime(2025, 9, 14, 10, 32, 57, tzinfo=pytz.utc), 'Last Quarter'),
        (datetime(2025, 9, 21, 19, 54, 8, tzinfo=pytz.utc), 'New Moon'),
        (datetime(2025, 9, 29, 23, 53, 50, tzinfo=pytz.utc), 'First Quarter'),
        (datetime(2025, 10, 7, 3, 47, 37, tzinfo=pytz.utc), 'Full Moon'),
        (datetime(2025, 10, 13, 18, 12, 42, tzinfo=pytz.utc), 'Last Quarter'),
        (datetime(2025, 10, 21, 12, 25, 10, tzinfo=pytz.utc), 'New Moon'),
        (datetime(2025, 10, 29, 16, 20, 49, tzinfo=pytz.utc), 'First Quarter'),
        (datetime(2025, 11, 5, 13, 19, 18, tzinfo=pytz.utc), 'Full Moon'),
        (datetime(2025, 11, 12, 5, 28, 9, tzinfo=pytz.utc), 'Last Quarter'),
        (datetime(2025, 11, 20, 6, 47, 16, tzinfo=pytz.utc), 'New Moon'),
        (datetime(2025, 11, 28, 6, 58, 48, tzinfo=pytz.utc), 'First Quarter'),
        (datetime(2025, 12, 4, 23, 14, 4, tzinfo=pytz.utc), 'Full Moon'),
        (datetime(2025, 12, 11, 20, 51, 41, tzinfo=pytz.utc), 'Last Quarter'),
        (datetime(2025, 12, 20, 1, 43, 21, tzinfo=pytz.utc), 'New Moon'),
        (datetime(2025, 12, 27, 19, 9, 51, tzinfo=pytz.utc), 'First Quarter')
    ]
